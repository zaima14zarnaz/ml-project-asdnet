...
if __name__ == '__main__':
    weight_path = "/home/zaimaz/Desktop/research1/QAGNet/asdNet3/Attention_Shift_Ranks/Attention_Shift_Saliency_Rank/weights/ASRNet_model_weights(4).h5"    # add pre-trained weight path
