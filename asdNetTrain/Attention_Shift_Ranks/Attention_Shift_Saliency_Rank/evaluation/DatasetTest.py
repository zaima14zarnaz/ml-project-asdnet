...
class DatasetTest(object):
    ...
    def load_rank_order_data(self, rank_order_root):
        ...
        gt_rank_orders = []
        # print(len(rank_order_data_files))
    ...
    def load_gt_mask(self, image_id):
        # Load mask
        p = self.dataset_root + "/gt/" + self.data_split + "/" + os.path.splitext(image_id)[0]  + ".png"
        # print(p)
        # /home/zaimaz/Desktop/research1/SaliencyRanking/Dataset/IRSR_dataset/dataset/images/test/gt
        # /home/zaimaz/Desktop/research1/SaliencyRanking/Dataset/IRSR_dataset/dataset/images/test/gt/COCO_val2014_000000144878.png
        # /home/zaimaz/Desktop/research1/SaliencyRanking/Dataset/IRSR_dataset/dataset/test/gt/COCO_val2014_000000144878.png
    ...
    def load_object_roi_masks(self, image_id):
        ...
        obj_masks = np.stack(obj_mask_instances, axis=2).astype(bool)
