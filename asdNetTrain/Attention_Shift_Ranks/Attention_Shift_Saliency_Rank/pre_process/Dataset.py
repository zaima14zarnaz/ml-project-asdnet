...
class Dataset(object):
    ...
    def load_dataset(self):
        ...
        for idx, (i,j) in enumerate(zip(self.gt_rank_orders, self.img_ids)):
            print(i, j)
            if idx == 10:
                break
    ...
    def load_rank_order_data(self, rank_order_root):
        ...
        print(rank_order_data_files[0:10])
        gt_rank_orders = []
    ...
    def load_gt_rank_order(self, image_id):
        ...
        # Shuffle data
        # Fancy indexing, array[indices] - not working so use np.take
